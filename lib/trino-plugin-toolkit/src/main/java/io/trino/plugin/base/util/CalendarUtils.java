...
public final class CalendarUtils
{
    ...
    static int toProlepticDaysFromString(String hybridDate)
    {
        try {
    ...
    static String formatDaysInProlepticCalendar(long epochDays)
    {
        return PROLEPTIC_CALENDAR_DATE_FORMAT.get().format(new Date(TimeUnit.DAYS.toMillis(epochDays)));
    }

    static String formatDaysInHybridCalendar(int hybridDays)
    {
    ...
    private static int convertProlepticDaysToHybridDays(int prolepticDays)
    {
        ...
        return toHybridDaysFromString(formatDaysInProlepticCalendar(localDate.toEpochDay()));
    }

    static int convertHybridDaysToProlepticDays(int hybridDays)
    {
        return toProlepticDaysFromString(formatDaysInHybridCalendar(hybridDays));
    }
